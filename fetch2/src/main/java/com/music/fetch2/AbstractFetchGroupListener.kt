...
/**
 * An abstract FetchGroupListener used by Fetch to report the different statuses and changes of the downloads
 ...
 * */
abstract class AbstractFetchGroupListener: FetchGroupListener {
