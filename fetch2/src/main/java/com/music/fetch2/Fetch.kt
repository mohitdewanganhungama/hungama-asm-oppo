...
import com.hungama.fetch2.exception.FetchException
import com.hungama.fetch2.fetch.FetchImpl
import com.hungama.fetch2.fetch.FetchModulesBuilder
import com.hungama.fetch2.util.DEFAULT_AUTO_RETRY_ATTEMPTS
import com.hungama.fetch2.util.DEFAULT_ENABLE_LISTENER_NOTIFY_ON_ATTACHED
import com.hungama.fetch2.util.DEFAULT_ENABLE_LISTENER_NOTIFY_ON_REQUEST_UPDATED
...
interface Fetch {
     ...
     * @see com.hungama.fetch2.FetchConfiguration
     * */
     ...
     * @see com.hungama.fetch2.Request for more details.
     ...
     * Use com.hungama.fetch2.NetworkType.GLOBAL_OFF to disable the global network preference.
     * The default value is com.hungama.fetch2.NetworkType.GLOBAL_OFF
     * @see com.hungama.fetch2.NetworkType
    ...
    companion object Impl {
        ...
        fun getDefaultInstance(): Fetch {
            return synchronized(lock) {
                val fetchConfiguration = defaultFetchConfiguration ?: throw FetchException(GLOBAL_FETCH_CONFIGURATION_NOT_SET)
