...
import com.hungama.fetch2.util.*
...
class FetchConfiguration private constructor(val appContext: Context,
    ...
    * */
    ...
    class Builder(context: Context) {
         ...
         * @see com.hungama.fetch2core.Downloader
         * @see com.hungama.fetch2.HttpUrlConnectionDownloader
         * @see com.hungama.fetch2okhttp.OkHttpDownloader
         ...
         * @see com.hungama.fetch2.Downloader
         * @see com.hungama.fetch2.FileServerDownloader
         ...
         * @see com.hungama.fetch2.FetchListener.onProgress is called for each
