package com.hungama.fetch2.database

import androidx.room.*
import com.hungama.fetch2.Status
import com.hungama.fetch2.database.DownloadDatabase.Companion.COLUMN_CREATED
import com.hungama.fetch2.database.DownloadDatabase.Companion.COLUMN_FILE
import com.hungama.fetch2.database.DownloadDatabase.Companion.COLUMN_GROUP
import com.hungama.fetch2.database.DownloadDatabase.Companion.COLUMN_ID
import com.hungama.fetch2.database.DownloadDatabase.Companion.COLUMN_IDENTIFIER
import com.hungama.fetch2.database.DownloadDatabase.Companion.COLUMN_PRIORITY
import com.hungama.fetch2.database.DownloadDatabase.Companion.COLUMN_STATUS
import com.hungama.fetch2.database.DownloadDatabase.Companion.COLUMN_TAG
import com.hungama.fetch2.database.DownloadDatabase.Companion.TABLE_NAME
