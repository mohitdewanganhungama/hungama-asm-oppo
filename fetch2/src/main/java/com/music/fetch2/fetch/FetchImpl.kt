...
import com.hungama.fetch2.getErrorFromMessage
import com.hungama.fetch2.fetch.FetchModulesBuilder.Modules
import com.hungama.fetch2.util.ActiveDownloadInfo
import com.hungama.fetch2.util.DEFAULT_ENABLE_LISTENER_AUTOSTART_ON_ATTACHED
import com.hungama.fetch2.util.DEFAULT_ENABLE_LISTENER_NOTIFY_ON_ATTACHED
import com.hungama.fetch2.util.toDownloadInfo
...
open class FetchImpl constructor(override val namespace: String,
    ...
    override fun awaitFinishOrTimeout(allowTimeInMilliseconds: Long) {
        com.hungama.fetch2.util.awaitFinishOrTimeout(allowTimeInMilliseconds, fetchHandler)
    }
