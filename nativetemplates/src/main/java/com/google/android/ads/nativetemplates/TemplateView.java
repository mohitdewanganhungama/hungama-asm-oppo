...
public class TemplateView extends FrameLayout {
  ...
  private static final String SPLASH_TEMPLATE = "splash_template";
  private static final String PLAYLIST_TEMPLATE = "playlist_template";
  private static final String MUSIC_VIDEO_TEMPLATE = "music_video_template";
  private static final String PODCAST_TEMPLATE = "podcast_template";
  ...
  public void setNativeAd(NativeAd nativeAd) {
    ...
    /*if (nativeAd.getMediaContent().getMainImage() != null){
      nativeAdView.getLayoutParams().height = nativeAd.getMediaContent().getMainImage().getMinimumHeight();
      nativeAdView.getLayoutParams().width = nativeAd.getMediaContent().getMainImage().getMinimumWidth();
    ...
    if (getTemplateTypeName().equals(PODCAST_TEMPLATE)){
      if (showMoreTextView != null) {
        ...
        showMoreTextView.setShowingLine(1);
        showMoreTextView.addShowMoreText("read more");
        showMoreTextView.addShowLessText("read less");
        showMoreTextView.setShowMoreColor(Color.parseColor("#FFFFFF"));
        showMoreTextView.setShowLessTextColor(Color.parseColor("#FFFFFF"));
        showMoreTextView.setShowMoreStyle(Typeface.BOLD);
        showMoreTextView.setShowLessStyle(Typeface.BOLD);
      }
    }else {
      if (tertiaryView != null) {
  ...
  public String getTemplateTypeName() {
    ...
    }else if (templateType == R.layout.gnt_splash_template_view){
      return SPLASH_TEMPLATE;
    }else if (templateType == R.layout.gnt_playlist_template_view){
      return PLAYLIST_TEMPLATE;
    }else if (templateType == R.layout.gnt_music_video_template_view){
      return MUSIC_VIDEO_TEMPLATE;
    }else if (templateType == R.layout.gnt_podcast_template_view){
  ...
  public void onFinishInflate() {
    ...
    if (getTemplateTypeName().equals(PODCAST_TEMPLATE)){
      showMoreTextView = findViewById(R.id.body);
    }else {
