...
import com.hungama.music.databinding.RowItype11Binding
 ...
 */
class iType11Adapter(
    val context: Context,
    var arrayList: List<BodyRowsItemsItem?>,
    val onitemclick: OnItemClick?
) :
    RecyclerView.Adapter<iType11Adapter.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val binding: RowItype11Binding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.row_itype_11,
            parent,
            false
        )
    ...
    class ItemViewHolder(val binding: RowItype11Binding) : RecyclerView.ViewHolder(binding.root)
