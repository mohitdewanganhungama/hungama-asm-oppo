...
import com.hungama.music.databinding.RowItype4Binding
...
class iType4Adapter(
    ...
    RecyclerView.Adapter<iType4Adapter.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val binding: RowItype4Binding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.row_itype_4,
            parent,
            false
        )
    ...
    class ItemViewHolder(val binding: RowItype4Binding) : RecyclerView.ViewHolder(binding.root)
