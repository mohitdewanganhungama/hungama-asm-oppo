...
import com.hungama.music.databinding.RowArtistNewReleaseBinding
 ...
 */
class ArtistNewReleaseAdapter(
    val context: Context,
    var arrayList: List<BodyRowsItemsItem?>?,
    val onitemclick: OnItemClick?
) :
    RecyclerView.Adapter<ArtistNewReleaseAdapter.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val binding: RowArtistNewReleaseBinding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.row_artist_new_release,
            parent,
            false
        )
    ...
    class ItemViewHolder(val binding: RowArtistNewReleaseBinding) :
