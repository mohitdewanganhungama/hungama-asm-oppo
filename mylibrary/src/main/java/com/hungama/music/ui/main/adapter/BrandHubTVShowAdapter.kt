...
import com.hungama.music.databinding.RowItype13Binding
import com.hungama.music.data.model.CollectionDetailModel

class BrandHubTVShowAdapter(
    val context: Context,
    val onitemclick: OnItemClick?
) :
    RecyclerView.Adapter<BrandHubTVShowAdapter.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val binding: RowItype13Binding = DataBindingUtil.inflate(
    ...
    class ItemViewHolder(val binding: RowItype13Binding) :
