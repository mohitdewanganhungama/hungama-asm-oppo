...
class UnCastOptionsProvider : OptionsProvider {
//    .setReceiverApplicationId(androidx.media3.cast.DefaultCastOptionsProvider.APP_ID_DEFAULT_RECEIVER_WITH_DRM)
//    .setReceiverApplicationId(HungamaMusicApp.getInstance().getString(R.string.chormecast_app_id))
