...
import com.hungama.music.databinding.RowItype5Binding
...
class iType5Adapter(
    ...
    RecyclerView.Adapter<iType5Adapter.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val binding: RowItype5Binding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.row_itype_5,
            parent,
            false
        )
    ...
    class ItemViewHolder(val binding: RowItype5Binding) :
