...
class PodcastTabFragment : BaseFragment(), OnParentItemClickListener, TracksContract.View, BucketParentAdapter.OnMoreItemClick,
    ...
    var CONTENT_TYPE = 0
    var headItemsItem: HeadItemsItem?=HeadItemsItem(page="podcast", title="podcast")
    var isDirectPlay = 0
    ...
    override fun initializeComponent(view: View) {
        setLog("onResume", "PodcastTabFragment-initializeComponent-title-${headItemsItem?.title}")
...
//                        setData(it, false)
            ...
            tracksViewModel = TracksViewModel(Injection.provideTrackRepository(), this@PodcastTabFragment)
...
//                dailyDoseAPICall(DiscoverMainTabFragment.mHomeModel)
            ...
            if (isCategoryPage && !TextUtils.isEmpty(categoryName) && !TextUtils.isEmpty(categoryId)){
                ...
                addFragment(R.id.fl_container, this@PodcastTabFragment, categoryDetailFragment, false)
                ...
                addFragment(R.id.fl_container, this@PodcastTabFragment, searchAllTabFragment, false)
            }
            MoEInAppHelper.getInstance().addInAppLifeCycleListener(this@PodcastTabFragment)
