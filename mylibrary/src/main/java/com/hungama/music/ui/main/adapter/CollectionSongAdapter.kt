 ...
 */
class CollectionSongAdapter(
    val context: Context,
    var arrayList: List<CollectionDetailModel.Data.Body.TSeriesSong?>?,
    val onitemclick: OnItemClick?
) :
    RecyclerView.Adapter<CollectionSongAdapter.ItemViewHolder>() {

    private val ROW_TYPE_1 = 1
    private val ROW_TYPE_2 = 2


    fun addData(list: List<CollectionDetailModel.Data.Body.TSeriesSong?>?) {
        arrayList = list
