...
import com.hungama.music.databinding.RowPopularVideoBinding
...
class PopularVideoAdapter(
    ...
    RecyclerView.Adapter<PopularVideoAdapter.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        if (viewType == ROW_TYPE_1) {
            ...
            val binding: RowPopularVideoBinding = DataBindingUtil.inflate(
                LayoutInflater.from(parent.context),
                R.layout.row_popular_video,
                parent,
                false
            )
    ...
    class ItemViewHolder(val binding: RowPopularVideoBinding) :
