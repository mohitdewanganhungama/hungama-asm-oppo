...
import com.hungama.music.databinding.RowNewsBinding
 ...
 */
class ArtistLatestNewsAdapter(
    val context: Context,
    var arrayList: List<BodyRowsItemsItem?>?,
    val onitemclick: OnItemClick?
) :
    RecyclerView.Adapter<ArtistLatestNewsAdapter.ItemViewHolder>() {
    ...
    class ItemViewHolder(val binding: RowNewsBinding) :
