...
import com.hungama.music.databinding.RowItype14Binding
 ...
 */
class CollectionTVShowAdapter(
    val context: Context,
    var arrayList: ArrayList<BodyRowsItemsItem?>?,
    val onitemclick: OnItemClick?
) :
    RecyclerView.Adapter<CollectionTVShowAdapter.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val binding: RowItype14Binding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.row_itype_13,
            parent,
            false
        )
    ...
    class ItemViewHolder(val binding: RowItype14Binding) :
