...
package com.hungama.music.utils.customview.widget;
...
public class MovieView extends RelativeLayout {
    ...
    public void startVideo() {
        ...
        try (AssetFileDescriptor fd = getResources().openRawResourceFd(mVideoResourceId)) {
            ...
            CommonUtils.INSTANCE.setLog( "Failed to open video", e.getMessage().toString());
        }
    }
    ...
    void adjustToggleState() {
        if (mMediaPlayer != null && mMediaPlayer.isPlaying()) {
            mToggle.setContentDescription(getResources().getString(androidx.media3.cast.R.string.cast_pause));
            mToggle.setImageResource(R.drawable.ic_pause);
        } else {
            mToggle.setContentDescription(getResources().getString(androidx.media3.cast.R.string.cast_play));
