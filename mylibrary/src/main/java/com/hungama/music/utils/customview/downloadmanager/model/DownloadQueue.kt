...
data class DownloadQueue(
    ...
    var downloadStatus: Int = Status.QUEUED.value,
    ...
    var downloadAll:Int = 0, //0-false, 1-true
    var parentThumbnailPath:String? = "",
    var downloadRetry:Int = 0, // max 3 retry
    var isFavorite:Int = 0, //0-false, 1-true

    var downloadedFilePath: String = "",
    var totalDownloadBytes: Long = -1,
    var downloadedBytes: Long = -1,
