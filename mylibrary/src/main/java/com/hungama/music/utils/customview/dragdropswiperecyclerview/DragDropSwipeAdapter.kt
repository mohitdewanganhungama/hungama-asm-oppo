package com.hungama.music.utils.customview.dragdropswiperecyclerview
...
import com.hungama.music.utils.customview.dragdropswiperecyclerview.listener.OnItemDragListener
import com.hungama.music.utils.customview.dragdropswiperecyclerview.listener.OnItemSwipeListener
import com.hungama.music.utils.customview.dragdropswiperecyclerview.util.DragDropSwipeDiffCallback
import com.hungama.music.utils.customview.dragdropswiperecyclerview.util.DragDropSwipeTouchHelper
import com.hungama.music.utils.customview.dragdropswiperecyclerview.util.drawHorizontalDividers
import com.hungama.music.utils.customview.dragdropswiperecyclerview.util.drawVerticalDividers
...
abstract class DragDropSwipeAdapter<T, U : DragDropSwipeAdapter.ViewHolder>(
    ...
    private fun drawOnSwiping(
        ...
        recyclerView?.let { list ->
            ...
            val isSwipingHorizontally = (orientation.swipeFlagsValue and DragDropSwipeRecyclerView.ListOrientation.DirectionFlag.RIGHT.value == DragDropSwipeRecyclerView.ListOrientation.DirectionFlag.RIGHT.value)
                    || (orientation.swipeFlagsValue and DragDropSwipeRecyclerView.ListOrientation.DirectionFlag.LEFT.value == DragDropSwipeRecyclerView.ListOrientation.DirectionFlag.LEFT.value)
