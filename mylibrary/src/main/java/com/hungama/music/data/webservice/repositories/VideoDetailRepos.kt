...
class VideoDetailRepos {
    ...
    fun getVideoDetail(context: Context, id: String): MutableLiveData<Resource<PlaylistDynamicModel>> {
        CoroutineScope(Dispatchers.IO).launch{
            val url = WSConstants.METHOD_PLAYABLE_CONTENT_DYNAMIC + id + "/musicvideo/detail"
                ...
                override fun setJsonDataResponse(response: JSONObject?) {
                    ...
                    try {
                        ...
                        CoroutineScope(Dispatchers.IO).launch {
                            ...
                            hashMap.put(EventConstant.NAME_EPROPERTY, "music_video_detailsscreen")
                            hashMap.put(
