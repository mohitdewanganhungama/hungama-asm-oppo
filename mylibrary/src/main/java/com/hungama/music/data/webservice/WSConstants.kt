...
object WSConstants {
     ...
     */
    //Production
//       private var PAGE_BASE_URL = "https://cpage.api.hungama.com" x
//    private var PAGE_BASE_URL = "https://pagehmop.api.hungama.com"

    //cached api
    private var PAGE_BASE_URL = "https://chmop-page.api.hungama.com"


    //    private var PAGE_DETAIL_URL = "https://page.api.hungama.com"

    //cached api
    private var PAGE_DETAIL_URL = "https://chmop-page.api.hungama.com"
...
//    private val SEARCH_BASE_URL = "https://csearch.api.hungama.com"
    ...
    //cached api
    private val SEARCH_BASE_URL = "https://chmop-search.api.hungama.com"

//    private val RECOMMENDED_BASE_URL = "https://recommendation.api.hungama.com"

    //cached api
    private val RECOMMENDED_BASE_URL = "https://chmop-recommendation.api.hungama.com"

//    private var URL_BASE_URL = "https://raurls.api.hungama.com"

    //cached api
    private var URL_BASE_URL = "https://chmop-urls.api.hungama.com"
...
//        private val REWARDS_BASE_URL = "https://rewards.api.hungama.com"
    ...
    var METHOD_SSO_LOGIN = "https://h-accountshmop.hungama.com/webservice/music/"
    ...
    var METHOD_USER_ACTION = "https://h-accountshmop.hungama.com/webservice/api/user.php"
...
//var HOME_BANNER = "https://bannerhmop.api.hungama.com/v1/page/banner?"
    ...
    //cached API
    var HOME_BANNER = "https://chmop-banner.api.hungama.com/v1/page/banner?"
    ...
    var METHOD_RECOMMENDATION_TRENDING =
        "https://stgsearch.api.hungama.com/v2/recommendation/trending"
    ...
    var METHOD_YOU_MAY_LIKE_MUSIC_VIDEO =
        "$SEARCH_BASE_URL/v2/recommendation/You-May-Like-Music-Video"
    ...
    var METHOD_ALBUM_DETAIL_FEATURED_PLAYLIST =
        "$SEARCH_BASE_URL/v2/recommendation/Album-Detail-Featured-Playlists"
    var METHOD_ALBUM_DETAIL_ARTIST_FOR_YOU =
        "$SEARCH_BASE_URL/v2/recommendation/Album-Detail-Artists-For-You"
    ...
    var METHOD_GENERIC_TRENDING_PLAYLIST =
        "$SEARCH_BASE_URL/v2/recommendation/generic-trending-playlist"
    ...
    //page api, search, accounts, recommendation, raurl
