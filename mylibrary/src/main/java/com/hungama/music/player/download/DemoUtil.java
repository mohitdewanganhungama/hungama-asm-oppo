  ...
  public static synchronized HttpDataSource.Factory getHttpDataSourceFactory(Context context) {
    if (httpDataSourceFactory == null) {
      if (USE_CRONET_FOR_NETWORKING) {
        ...
        httpDataSourceFactory = new DefaultHttpDataSource.Factory().setUserAgent(USER_AGENT).setAllowCrossProtocolRedirects(true);
...
//              new DownloadNotificationHelper(context, DOWNLOAD_NOTIFICATION_CHANNEL_ID);
  ...
  private static synchronized void upgradeActionFile(
    ...
    try {
      ...
      CommonUtils.INSTANCE.setLog( "Failed to upgrade action file: " + fileName, e.getMessage().toString());
    }
  }
...
//      downloadDirectory = new File(Environment.getExternalStorageDirectory().toString() + "/" + context.getString(R.string.dir_name));
