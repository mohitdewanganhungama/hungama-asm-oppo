...
public class LayoutBottomSheetBindingImpl extends LayoutBottomSheetBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.cancelBtn, 2);
        sViewsWithIds.put(R.id.nameToolbar, 3);
        sViewsWithIds.put(R.id.bottomSheet, 4);
        sViewsWithIds.put(R.id.webView, 5);
        sViewsWithIds.put(R.id.extraSpace, 6);
    ...
    public LayoutBottomSheetBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private LayoutBottomSheetBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
