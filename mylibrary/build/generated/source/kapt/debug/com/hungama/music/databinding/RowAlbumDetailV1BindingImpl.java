...
public class RowAlbumDetailV1BindingImpl extends RowAlbumDetailV1Binding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rlImageView_parent, 3);
        ...
        sViewsWithIds.put(R.id.rlFreeStrip, 8);
        sViewsWithIds.put(R.id.ivfreeStrips, 9);
        sViewsWithIds.put(R.id.tvTitle, 10);
        sViewsWithIds.put(R.id.ivE, 11);
        sViewsWithIds.put(R.id.tvSubTitle, 12);
        sViewsWithIds.put(R.id.ivMore, 13);
        sViewsWithIds.put(R.id.ivDownload, 14);
    }
    // views
    @NonNull
    ...
    public RowAlbumDetailV1BindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }
    private RowAlbumDetailV1BindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
