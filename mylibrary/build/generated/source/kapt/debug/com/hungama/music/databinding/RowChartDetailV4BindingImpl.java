...
public class RowChartDetailV4BindingImpl extends RowChartDetailV4Binding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ivStatus, 3);
        ...
        sViewsWithIds.put(R.id.llView, 11);
        sViewsWithIds.put(R.id.ivE, 12);
        sViewsWithIds.put(R.id.tvTitle, 13);
        sViewsWithIds.put(R.id.tvSubTitle, 14);
        sViewsWithIds.put(R.id.ivMore, 15);
        sViewsWithIds.put(R.id.ivDownload, 16);
    }
    // views
    @NonNull
    ...
    public RowChartDetailV4BindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 17, sIncludes, sViewsWithIds));
    }
    private RowChartDetailV4BindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
